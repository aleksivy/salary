...
Процедура УстановитьПараметрыОтборы()
	...
	УстановитьПараметр(КомпоновщикНастроек, "ДопБлага", ДопБлага );
КонецПроцедуры
...
Процедура ПриОткрытии()
	...
	Если Не ЗначениеЗаполнено(ДопБлага) Тогда ДопБлага = ПланыВидовРасчета.ОсновныеНачисленияОрганизаций.НайтиПоНаименованию("21. Додаткове благо (по рах 03773) для нарахування ПДФО та ВЗ"); КонецЕсли;
