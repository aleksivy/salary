...
Функция Печать() Экспорт
	...
	Дата = ТекущаяДата();
	ДатаДоговора = СсылкаНаОбъект.Дата;
	...
	Макет.Параметры.ДатаДоговора =  Формат(ДатаДоговора,"Л="+КодЯзыкаПечать+";ДЛФ=DD");
	Макет.Параметры.ДатаДопСоглашения =  Формат(Дата,"Л="+КодЯзыкаПечать+";ДЛФ=DD");
	// КодЕДРПОУ
	...
	// Временно
	//Если Дата >= '20170703' Тогда
	//	Макет.Параметры.ДолжностьПрижимова = "директора виконавчого Прижимова Д.В., що діє на підставі довіреності № 0307/17-ПВ від 03.07.2017 р.";
	//ИначеЕсли Дата >= '20170330' Тогда
	//	Макет.Параметры.ДолжностьПрижимова = "директора фінансового Прижимова Д.В., що діє на підставі доручення № 3003/17-ПВ від 30.03.2017 р.";
	//Иначе
	//	Макет.Параметры.ДолжностьПрижимова = "директора фінансового Прижимова Д.В., що діє на підставі доручення № 2708/16-ПВ від 27.08.2016 р.";
	//КонецЕсли;
...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Идентификатор = "ДоговорЗаймаГленкорДополнение"; //Внешняя печатная форма
