...
// Печать
//
Функция Печать( пСотрудник ) Экспорт
	...
	Для каждого лСтрока Из Объект.ОсновныеНачисления Цикл
		...
		Если Не лСтрока.Сотрудник = пСотрудник Тогда Продолжить; КонецЕсли;
		...
		лстрПараметрыШапка.Вставить("ДатаПриложения", Формат(дата(2020,1,2), "ДЛФ=ДД"));
		лстрПараметрыШапка.Вставить("ДатаПриложенияАнгл", Формат(дата(2020,1,2), "Л=en; ДЛФ=ДД"));
		лстрПараметрыШапка.Вставить("ДатаДействуетС", Формат(лСтрока.ДатаДействия, "ДЛФ=ДД"));
		лстрПараметрыШапка.Вставить("ДатаДействуетСАнгл", Формат(лСтрока.ДатаДействия, "Л=en; ДЛФ=ДД"));
