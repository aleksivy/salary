...
Процедура ПриОткрытии()
	...
	Если Не ЗначениеЗаполнено(Director) Тогда Director = Справочники.ДолжностиОрганизаций.НайтиПоКоду("000000001"); КонецЕсли;
	Если Не ЗначениеЗаполнено(BackOffice) Тогда BackOffice = Справочники.ДолжностиОрганизаций.НайтиПоКоду("000000002"); КонецЕсли;
	Если Не ЗначениеЗаполнено(Manager) Тогда Manager = Справочники.ДолжностиОрганизаций.НайтиПоКоду("000000003"); КонецЕсли;
