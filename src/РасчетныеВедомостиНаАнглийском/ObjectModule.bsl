...
// Серна - Начало
		Попытка лЗначение = ЭлементОтбора.ПравоеЗначение; Исключение Продолжить; КонецПопытки;
// Серна - Конец
		Если ТипЗнч(лЗначение) <> Тип("СправочникСсылка.Организации") Тогда
			Продолжить;
		Иначе
	...
	СписокОтветственных.Добавить(Перечисления.ОтветственныеЛицаОрганизаций.ФинДиректор);
	СписокОтветственных.Добавить(Перечисления.ОтветственныеЛицаОрганизаций.ЗамГлавБух);
