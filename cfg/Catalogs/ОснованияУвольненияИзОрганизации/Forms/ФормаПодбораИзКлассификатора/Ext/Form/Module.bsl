...
Процедура ПолеТабличногоДокументаОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Ссылка = Справочники.ОснованияУвольненияИзОрганизации.НайтиПоНаименованию(Статья + ". " + Наименование);

	Если НЕ Ссылка.Пустая() Тогда
		
		Вопрос = НСтр("ru='В справочнике ""Основания увольнения из организации"" уже существует элемент с наименованием ""';uk='У довіднику ""Підстави звільнення з організації"" вже існує елемент з найменуванням ""'") + Наименование + НСтр("ru='""! Открыть существующий?';uk='""! Відкрити існуючий?'");
	...
	ФормаНовогоЭлемента = Справочники.ОснованияУвольненияИзОрганизации.ПолучитьФормуНовогоЭлемента(, ВладелецФормы, );
	ФормаНовогоЭлемента.Наименование = Наименование;
	ФормаНовогоЭлемента.Код	      	 = Код;
	ФормаНовогоЭлемента.СтатьяЗакона = Статья;
