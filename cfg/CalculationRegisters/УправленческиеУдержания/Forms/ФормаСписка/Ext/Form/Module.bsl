...
Процедура РегистрРасчетаСписокПриПолученииДанных(Элемент, ОформленияСтрок)
	Для каждого ОформлениеСтроки Из ОформленияСтрок Цикл
		...
		РаботаСДиалогами.ПриВыводеСтрокиНачисленийИУдержаний(ОформлениеСтроки.ДанныеСтроки, ОформлениеСтроки, мСведенияОВидахРасчета, Ложь);
...
Процедура ДействияФормыРасчетныйЛисток(Кнопка)
	...
	УправлениеОтчетами.ВызовРасчетногоЛисткаИзФормыСпискаРР(ЭлементыФормы.РегистрРасчетаСписок.ТекущиеДанные,"УправленческиеУдержания");
