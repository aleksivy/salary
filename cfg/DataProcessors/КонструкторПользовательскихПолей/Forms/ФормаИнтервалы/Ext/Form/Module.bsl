...
Процедура ОсновныеДействияФормыОК(Кнопка)
	...
	Если ПустаяСтрока(Наименование) Тогда
		Сообщить(НСтр("ru='Наименование не заполнено';uk='Найменування не заповнене'"));
		Возврат;
	ИначеЕсли Не ЗначениеЗаполнено(Значение) Тогда
		Сообщить(НСтр("ru='Поле не заполнено';uk='Поле не заповнене'"));
		Возврат;
	ИначеЕсли Интервалы.Количество() = 0 Тогда
	    Сообщить(НСтр("ru='Необходимо заполнить хотя бы один интервал';uk='Необхідно заповнити хоча б один інтервал'"));
		Возврат;
	КонецЕсли;
...
Процедура КоманднаяПанельИнтервалыОчистить(Кнопка)
	...
	Ответ = Вопрос(НСтр("ru='Очистить все интевралы?';uk='Очистити всі інтервали?'"), РежимДиалогаВопрос.ДаНет);
