...
Процедура ФайлДанныхНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	Диалог.Фильтр = НСтр("ru='Файл данных (*.xml)|*.xml|Архивный файл данных (*.aml)|*.aml';uk='Файл даних (*.xml)|*.xml|Архівний файл даних (*.aml)|*.aml'");
