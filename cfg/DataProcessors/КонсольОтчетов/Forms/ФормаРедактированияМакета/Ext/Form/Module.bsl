...
Процедура КоманднаяПанель1МакетСОформлением(Кнопка)
	...
	МакетОформления = ВладелецФормы.ЭлементыФормы.ВариантОформления.СписокВыбора.ВыбратьЭлемент(НСтр("ru='Выберите макет оформления';uk='Виберіть макет оформлення'"));
