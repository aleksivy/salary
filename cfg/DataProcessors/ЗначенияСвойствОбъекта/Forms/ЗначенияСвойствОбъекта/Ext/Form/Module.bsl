...
Процедура ПриОткрытии()
	...
	ЭтаФорма.Заголовок = НСтр("ru='Свойства: ';uk='Властивості: '") + ОбработкаОбъектЗначенияСвойств.ОбъектОтбораЗначений;
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		Вопрос = НСтр("ru='Измененные значения свойств не были записаны! Сохранить изменения?';uk='Змінені значення властивостей не були записані! Зберегти зміни?'");
...
Процедура КоманднаяПанельДействиеПеречитать(Кнопка)
	...
	Если Модифицированность Тогда
		Вопрос = НСтр("ru='Измененные значения свойств не были записаны! Продолжить?';uk='Змінені значення властивостей не були записані! Продовжити?'");
