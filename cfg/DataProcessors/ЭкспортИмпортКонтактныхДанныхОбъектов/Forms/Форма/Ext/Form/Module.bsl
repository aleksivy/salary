...
Процедура КнопкаВыполнитьНажатие(Элемент)
	...
	ИначеЕсли ВидОперации = "Экспорт" Тогда
		...
		Если ПустаяСтрока(ПутьКФайлу) Тогда
			...
			Предупреждение(НСтр("ru='Выберите файл выгрузки.';uk='Виберіть файл вивантаження.'"));
			Возврат;
...
Процедура ПутьКФайлуНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	Если ВидОперации = "Импорт" Тогда
		...
		ВыборФайла.Заголовок = НСтр("ru='Выберите файл для импорта';uk='Виберіть файл для імпорту'");
	Иначе
		ВыборФайла = Новый ДиалогВыбораФайла(РежимДиалогаВыбораФайла.Сохранение);
		ВыборФайла.ПроверятьСуществованиеФайла = Ложь;
		ВыборФайла.Заголовок = НСтр("ru='Выберите файл для экспорта';uk='Виберіть файл для експорту'");
	КонецЕсли; 
