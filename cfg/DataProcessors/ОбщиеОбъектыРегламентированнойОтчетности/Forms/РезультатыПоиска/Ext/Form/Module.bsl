...
// соответствующую текущей строке таблицы резальтатов поиска.
// 
...
Процедура РезультатыПоискаПриПолученииДанных(Элемент, ОформленияСтрок)
	...
	Для Каждого ОформлениеСтроки ИЗ ОформленияСтрок Цикл
		Если ЗначениеЗаполнено(ОформлениеСтроки.ДанныеСтроки.Страница) И ОформлениеСтроки.ДанныеСтроки.Страница <> 1 Тогда
			ОформлениеСтроки.Ячейки.НаименованиеЛиста.УстановитьТекст(ОформлениеСтроки.ДанныеСтроки.НаименованиеЛиста + НСтр("ru=' (страница №';uk=' (сторінка №'") + ОформлениеСтроки.ДанныеСтроки.Страница + ")");
		КонецЕсли;
	КонецЦикла;
