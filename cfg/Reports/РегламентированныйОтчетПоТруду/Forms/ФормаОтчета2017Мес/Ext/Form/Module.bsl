...
//
Процедура ЗаполнитьНачальныеНастройки(Макет = "СоставПоказателей2017Мес") Экспорт
...
Функция ПолучитьТаблицуВариантовЗаполнения(ИмяСтраницыПанели, ПолучитьЭталонную = Ложь)
	...
	Если мСтруктураВариантыЗаполнения.Свойство(ИмяСтраницыПанели, МассивВариантовЗаполненияСтраниц) Тогда
		...
		Иначе
			...
			МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2017Мес");
...
Процедура ПоказатьПериод()
	...
	мОтчетПоТруду.Области.ПериодОтчета.Значение = "у " + ПериодОтчета;
...
мСоставПоказателей = "СоставПоказателей2017Мес";
