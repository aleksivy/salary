...
Процедура ПоказатьПериод()
	...
	СтрПериодОтчета = ПредставлениеПериода( НачалоГода(мДатаНачалаПериодаОтчета), КонецГода(мДатаКонцаПериодаОтчета), "ФП = Истина" );
...
Процедура ПриОткрытии()
	...
	мДатаКонцаПериодаОтчета  = КонецГода(РабочаяДата);
	мДатаНачалаПериодаОтчета = НачалоГода(мДатаКонцаПериодаОтчета);
