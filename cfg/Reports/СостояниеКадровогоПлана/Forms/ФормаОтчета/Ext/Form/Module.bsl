Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	Если Константы.РежимНабораПерсонала.Получить() = Перечисления.ВидыОрганизационнойСтруктурыПредприятия.ПоСтруктуреЮридическихЛиц Тогда
		СхемаКомпоновкиДанных = ПолучитьМакет("ПоСтруктуреЮридическихЛиц");
