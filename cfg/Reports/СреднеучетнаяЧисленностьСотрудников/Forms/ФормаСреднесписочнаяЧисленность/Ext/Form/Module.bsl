...
Процедура СформироватьЗаголовокФормы()
	...
	Заголовок = УправлениеОтчетами.СформироватьЗаголовокОсновнойФормы(ДатаНачала, ДатаКонца, НСтр("ru='Расчет среднеучетной численности штатных работников';uk='Розрахунок середньооблікової чисельності штатних працівників'"), 2);
...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	//"" = по всем, "Ж" = Женщины, "Инв" = Инвалиды, "Пен" = пенсионеры, "Иностранцы" = Иностранцы
	...
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("ПенНеИнв", НСтр("ru='Пенсионеры не инвалиды';uk='Пенсіонери не інваліди'"));
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("Инв", НСтр("ru='Инвалиды';uk='Інваліди'"));
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("ИнвНеПен", НСтр("ru='Инвалиды не пенсионеры';uk='Інваліди не пенсіонери'"));
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("ИнвПен", НСтр("ru='Инвалиды пенсионеры';uk='Інваліди пенсіонери'"));
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("Иностранцы", НСтр("ru='Иностранцы';uk='Іноземці'"));
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("ДопГарантии", НСтр("ru='С доп. гаратиями трудоустройства';uk='З дод. гарантіями працевлаштування'"));
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("ДопГарантииНеИнв", НСтр("ru='С доп. гар. труд. кроме инвалидов';uk='З дод. гар. прац. крім інвалідів'"));
	ЭлементыФормы.ВидОтчета.СписокВыбора.Добавить("ДопГарантии10Лет", НСтр("ru='Меньше 10 лет до пенсии';uk='Менше 10 років до пенсії'"));
	
	ЭлементыФормы.ВидРаботников.СписокВыбора.Добавить("", "");
	ЭлементыФормы.ВидРаботников.СписокВыбора.Добавить("Штатные", НСтр("ru='Штатные';uk='Штатні'"));
	ЭлементыФормы.ВидРаботников.СписокВыбора.Добавить("Совместители", НСтр("ru='Совместители';uk='Сумісники'"));
	ЭлементыФормы.ВидРаботников.СписокВыбора.Добавить("ГПХ", НСтр("ru='ГПХ';uk='ЦПХ'"));
...
//Процедура нужна для сценарного тестирования отчета
Процедура ВидРаботниковОкончаниеВводаТекста(Элемент, Текст, Значение, СтандартнаяОбработка)
