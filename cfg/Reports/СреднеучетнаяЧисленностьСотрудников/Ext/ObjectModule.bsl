...
Функция ПолучитьОтбор(знач ПараметрОтбора = "") Экспорт
	...
	Если  ПараметрОтбора = "ИНВ" ИЛИ ПараметрОтбора = "ПЕНСИОНЕРЫ" ИЛИ ПараметрОтбора = "ПЕН" ИЛИ ПараметрОтбора = "ИНОСТРАНЦЫ" ИЛИ ПараметрОтбора = "ДОПГАРАНТИИ" ИЛИ ПараметрОтбора = "ДОПГАРАНТИИНЕИНВ" ИЛИ ПараметрОтбора = "ДОПГАРАНТИИ10ЛЕТ" Тогда
