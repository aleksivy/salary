...
Процедура ВывестиНаПечатьЛист(СтруктураПараметровЛиста)
	...
	ИначеЕсли ИмяТабличногоПоля = "ПолеТабличногоДокументаТаблица5" Тогда
		...
		Макет = ПолучитьМакет("Таблица5_2018");
		...
		Для каждого СтрокаГруппы Из СтруктураГруппы Цикл
			...
			Строка.Параметры.ГПХ  = Формат(СтрокаГруппы.T1RG7,"ЧЦ=1; ЧН=");
			Строка.Параметры.Категория  = СтрокаГруппы.T1RG8;
			...
			Если ЗначениеЗаполнено(СтрокаГруппы.T1RG111) Тогда
				Строка.Параметры.ДатаНачала = СтрокаГруппы.T1RG111;	
			Иначе
				Строка.Параметры.ДатаНачала = "";	
			КонецЕсли;
			
			Если ЗначениеЗаполнено(СтрокаГруппы.T1RG112) Тогда
				Строка.Параметры.ДатаОкончания = СтрокаГруппы.T1RG112;	
			Иначе
				Строка.Параметры.ДатаОкончания = "";	
			КонецЕсли;
			
			Строка.Параметры.Профессия 			= СтрокаГруппы.T1RG12S;
			Строка.Параметры.КодЗКППТР 			= СтрокаГруппы.T1RG13;
			Строка.Параметры.КодКП 	   			= СтрокаГруппы.T1RG14S;
			Строка.Параметры.Должность 			= СтрокаГруппы.T1RG15S;
			Строка.Параметры.ДокументОснование 	= СтрокаГруппы.T1RG16S;
			Строка.Параметры.Основание		 	= СтрокаГруппы.T1RG17S;
			
			
			Если ЗначениеЗаполнено(СтрокаГруппы.T1RG18D) Тогда
				Строка.Параметры.ДатаСозданияРМ = Формат(СтрокаГруппы.T1RG18D, "ДФ=ddMMyyyy");
			Иначе
				Строка.Параметры.ДатаСозданияРМ = "";	
			КонецЕсли;
			
			Строка.Параметры.ВоенноеЗвание	 = СтрокаГруппы.T1RG19S;
	...
	ИначеЕсли ИмяТабличногоПоля = "ПолеТабличногоДокументаТаблица6" Тогда
		...
		Макет = ПолучитьМакет("Таблица6_2018");
		...
		Для каждого СтрокаГруппы Из СтруктураГруппы Цикл
			...
			Если ЗначениеЗаполнено(СтрокаГруппы.T1RG111) Тогда
				ЗначениеВКлетку(СтрокаГруппы.T1RG111, Истина,  2,  "Месяц",    Строка, Истина);
				ЗначениеВКлетку(СтрокаГруппы.T1RG112, Истина,  4,  "Год",      Строка, Истина);
			Иначе
				ЗначениеВКлетку("    ", Истина,  2,  "Месяц",    Строка, Истина);
				ЗначениеВКлетку("    ", Истина,  4,  "Год",    Строка, Истина);
			КонецЕсли;
			
			ЗначениеВКлетку(СтрокаГруппы.T1RG13, Ложь,        3, "КвоБольничных",    Строка, Истина);			
			ЗначениеВКлетку(СтрокаГруппы.T1RG14, Ложь,        3, "КвоБезЗП",         Строка, Истина);			
	...
	ИначеЕсли ИмяТабличногоПоля = "ПолеТабличногоДокументаТаблица7" Тогда
		...
		Макет = ПолучитьМакет("Таблица7_2018");
		...
		Для каждого СтрокаГруппы Из СтруктураГруппы Цикл
			...
			Если ЗначениеЗаполнено(СтрокаГруппы.T1RG10) Тогда
				ЗначениеВКлетку(СтрокаГруппы.T1RG10, Истина,    2, "ДатаНач",    Строка, Истина);
			Иначе
				ЗначениеВКлетку("", Ложь,    2, "ДатаНач",    Строка, Истина);
			КонецЕсли;
			
			Если ЗначениеЗаполнено(СтрокаГруппы.T1RG11) Тогда
				ЗначениеВКлетку(СтрокаГруппы.T1RG11, Истина,    2, "ДатаКон",    Строка, Истина);
			Иначе				
...
Процедура РазбитьПечатнуюФорму(ПечФорма, ИмяФормы = "")
	...
	ПустойТаблДок.МасштабПечати = ПечФорма.МасштабПечати;
	...
	Пока Сч < ПечФорма.ВысотаТаблицы Цикл
		...
		Если НЕ ПустойТаблДок.ПроверитьВывод(ПечФорма.ПолучитьОбласть(ПослВерх, 0, Сч, 0)) Тогда
			...
			НовТаблДок.МасштабПечати = ПечФорма.МасштабПечати;
...
Функция Сохранить() Экспорт
	...
	СписокСохранения.Вставить("КадровыйПереводДвумяСтроками", КадровыйПереводДвумяСтроками);
	СохранитьЗначение("РегламентированнаяОтчетность_ЕСВ_КадровыйПереводДвумяСтроками", 	КадровыйПереводДвумяСтроками);	
...
Функция ПолучитьСписокВидовРасчетовПоВидуНалога(Налог) Экспорт // Экспортируем для использования в форме настройки FREDO Звіт 
...
Функция ПолучитьСписокБезСохранения() Экспорт // Экспортируем для использования в форме настройки FREDO Звіт
...
Функция ПолучитьСписокДекретные() Экспорт // Экспортируем для использования в форме настройки FREDO Звіт
...
Функция ПолучитьСписокПоУходу() Экспорт // Экспортируем для использования в форме настройки FREDO Звіт
...
Функция ПолучитьСписокПоУходуДо3() Экспорт // Экспортируем для использования в форме настройки FREDO Звіт
...
Процедура ВыполнитьИнициализацию()
	...
	ТаблицаНужныхСтатей.Колонки.Добавить("ПолеВзносПолная");
...
Процедура ЗаполнитьАвто()  Экспорт
	...
	Если    (РегламентированнаяОтчетность.ИДКонфигурации() = "УПП") 
		...
		Если УсловиеНаПодразделение() <> "" Тогда
			Сообщить(НСтр("ru = 'В форме отчета указано подразделение. Невозможно заполнить количество сотрудников, работающих по ГПХ в Таблице 1 только по подразделению."
						"Будет указано количество в целом по организации.'; uk = 'У формі звіту зазнечний Підрозділ. Неможливо заповнити кількість співробітників, що працюють за договорами ЦПХ у Таблиці 1 лише по підрозділу. "
						"Буде зазначена кількість в цілому по організації.'"));
		КонецЕсли;
	...
	ЗапросУЧ.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ РАЗРЕШЕННЫЕ
		    |	КОЛИЧЕСТВО(РаботникиОрганизаций.Сотрудник.Физлицо) КАК Количество
		    |ИЗ
		    |	Регистрсведений.РаботникиОрганизаций.СрезПоследних(&ДатаСреза, Организация = &Организация И Сотрудник.ВидЗанятости = ЗНАЧЕНИЕ(Перечисление.ВидыЗанятостиВОрганизации.ОсновноеМестоРаботы)) КАК РаботникиОрганизаций
			|ГДЕ
			...
			|      ИЛИ РаботникиОрганизаций.Период < &ДатаСреза)
			|";
			
	
	ЗапросУЧ.УстановитьПараметр("ДатаСреза",мДатаНачалаПериодаОтчета+86400);
	ЗапросУч.УстановитьПараметр("Организация",Организация);
    ...
    УстановитьЗначениеПоказателя("HNACTL3", УчетнаяЧисленность);
	...
	Попытка
		//Добавлено получение суммы по полной ставке
		...
		Для каждого СтрокаБаз Из ТаблицаБазВзносов Цикл
			...
			Если СтрокаТаблицы <> Неопределено Тогда
				...
				Если СтрокаБаз.ТипНачисления < 2 Тогда
					...
					ДобавитьЗначениеВСтруктуру(ПоляОтчета, СтрокаТаблицы.ПолеВзносПолная, СуммаВзносаПолная);
...
Функция СформироватьСпецСтажТаблица7(ТаблицаПриемовУвольнений)
	...
	Если  НЕ Метаданные.РегистрыСведений.Найти("СпецстажРаботниковОрганизаций") = Неопределено Тогда
		...
		Для каждого СтрокаСпецСтажа Из ТаблицаСпецСтажа Цикл
			...
			ДобавленнаяСтрока.T1RG10  = День(СтрокаСпецСтажа.НачалоДействия);
			ДобавленнаяСтрока.T1RG11  = День(СтрокаСпецСтажа.КонецДействия);
	...
	ИначеЕсли НЕ Метаданные.РегистрыСведений.Найти("НачальныеСведенияОСтажеРаботниковОрганизации") = Неопределено Тогда
		...
		Для каждого СтрокаСпецСтажа Из ТаблицаСпецСтажа Цикл
			...
			Если НЕ СтрокаПриемаУвольнений = Неопределено Тогда
				...
				КонецЕсли;
			КонецЕсли;
			ДобавленнаяСтрока.T1RG10 	= День(ДатаНач);
	        ДобавленнаяСтрока.T1RG11	= День(ДатаКон);
...
Функция  СформироватьСписокТрудовыхОтношенийТаблица5()
	...
	Если (РегламентированнаяОтчетность.ИДКонфигурации() = "БП") Тогда
		...
		СписокУволенныхСотрудниковБП = Новый Соответствие;
	КонецЕсли;
	
	Номер = 1;
	Для Каждого стр ИЗ Работавшие Цикл
		
		Если стр.ПричинаИзмененияСостояния = Перечисления.ПричиныИзмененияСостояния.Перемещение И (НачалоДня(стр.ДатаПриема)-1)>= мДатаНачалаПериодаОтчета И КадровыйПереводДвумяСтроками Тогда
			...
			ТекСтрока.T1RG112  = День(НачалоДня(стр.ДатаПриема)-1);
			ТекСтрока.T1RG16S  = ОбработатьПредставлениеОснования(стр.Основание, стр.ОснованиеДата);
			
			ТекСтрока.T1RG12S   = СокрЛП(стр.ДолжностьНаименованиеПоКППредыдущий);
			ТекСтрока.T1RG13    = СокрЛП(стр.КодЗКППТРПредыдущий);
			ТекСтрока.T1RG14S   = СокрЛП(стр.ДолжностьКодКППредыдущий);
			ТекСтрока.T1RG15S   = СокрЛП(стр.ДолжностьПредыдущий);
		...
		Если стр.ПричинаИзмененияСостояния = Перечисления.ПричиныИзмененияСостояния.Перемещение И Месяц(стр.ДатаПриема) <> Месяц(мДатаНачалаПериодаОтчета) Тогда
		...
		Если ЗначениеЗаполнено(стр.ДатаПриема) Тогда
			ТекСтрока.T1RG111  = День(стр.ДатаПриема);
		КонецЕсли;	
		Если ЗначениеЗаполнено(стр.ДатаУвольнения) Тогда
			ТекСтрока.T1RG112  = День(стр.ДатаУвольнения);
		КонецЕсли;	
		ТекСтрока.T1RG16S  = ОбработатьПредставлениеОснования(стр.Основание, стр.ОснованиеДата);
		
		//Должность показываем для всех кадровых событий
		ТекСтрока.T1RG12S   = СокрЛП(стр.ДолжностьНаименованиеПоКП);
		ТекСтрока.T1RG13    = СокрЛП(стр.КодЗКППТР);
		ТекСтрока.T1RG14S   = СокрЛП(стр.ДолжностьКодКП);
		ТекСтрока.T1RG15S   = СокрЛП(стр.Должность);
		
		Если стр.ПричинаИзмененияСостояния = Перечисления.ПричиныИзмененияСостояния.Увольнение Тогда
			ТекСтрока.T1RG17S   = стр.СтатьяКЗОТ;
		Иначе

			
			Если ЗначениеЗаполнено(стр.ДатаСозданияРабочегоМеста) Тогда
				ТекСтрока.T1RG18D  = стр.ДатаСозданияРабочегоМеста;   
			КонецЕсли;
		...
		Если (РегламентированнаяОтчетность.ИДКонфигурации() = "БП") Тогда
			...
			Если ЗначениеЗаполнено(стр.ДатаПриема) И стр.Категория = 2 Тогда
				Если ЗначениеЗаполнено(стр.КодПоДРФО) Тогда
					СписокПринятыхСотрудниковБП.Вставить(стр.КодПоДРФО, Номер);		
				КонецЕсли;
			КонецЕсли;
			Если ЗначениеЗаполнено(стр.ДатаУвольнения) И стр.Категория = 2 Тогда
				Если ЗначениеЗаполнено(стр.КодПоДРФО) Тогда
					СписокУволенныхСотрудниковБП.Вставить(стр.КодПоДРФО, Номер);		
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;	
	...
	Для Каждого стр ИЗ ДоговораГПХ Цикл
		...
		СуществующийНомерСтрокиУвольнение = Неопределено;
		Если (РегламентированнаяОтчетность.ИДКонфигурации() = "БП") Тогда
			...
			Если ЗначениеЗаполнено(стр.КодПоДРФО) Тогда
				...
				СуществующийНомерСтрокиУвольнение = СписокУволенныхСотрудниковБП.Получить(стр.КодПоДРФО);
			КонецЕсли;
		КонецЕсли;	
		Если СуществующийНомерСтроки = Неопределено И СуществующийНомерСтрокиУвольнение = Неопределено Тогда
		...
		Иначе
			...
			Если РегламентированнаяОтчетность.ИДКонфигурации() = "БП" Тогда
				Если СуществующийНомерСтроки <> Неопределено Тогда
					...
					ТекСтрока.T1RG8   = 3;
					ТекСтрока.T1RG7   = Стр.ГПХпоОснМестуРаботы;
				КонецЕсли;
				Если СуществующийНомерСтрокиУвольнение <> Неопределено Тогда
					ТекСтрока = СтруктураГруппы5[СуществующийНомерСтрокиУвольнение-1];
					ТекСтрока.T1RG8   = 3;
					ТекСтрока.T1RG7   = Стр.ГПХпоОснМестуРаботы;
				КонецЕсли;
				Продолжить;     
	...
	Отпуска = ПолучитьСписокОтпуска(ТаблицаВРОтпускПоБеременностиИРодам.ВыгрузитьКолонку("ВидРасчета"),Истина);
	Для Каждого стр ИЗ Отпуска Цикл
...
Процедура СформироватьНачисленияВзносыТаблица6(СписокРаботниковСоСпецСтажем)
	...
	Пока ВыборкаТаблица6.Следующий() Цикл
		...
		ДобавленнаяСтрока["T1RG111"]	= Месяц(ВыборкаТаблица6.Период);
		ДобавленнаяСтрока["T1RG112"]	= Год(ВыборкаТаблица6.Период);
...
Функция  ПолучитьСписокЛиц()
	...
	Запрос.УстановитьПараметр("ПериодОтчета", НачалоМесяца(мДатаНачалаПериодаОтчета));
	...
	Запрос.Текст =
		...
		|	РаботникиОрганизаций.ГрафикРаботы.СокращенноеРабочееВремя КАК СокращенноеРабочееВремя,
		...
		|	ВЫБОР 
		|	 КОГДА РаботникиОрганизаций.ПричинаИзмененияСостояния = ЗНАЧЕНИЕ(Перечисление.ПричиныИзмененияСостояния.Увольнение) 
		|	 ТОГДА НАЧАЛОПЕРИОДА(ДОБАВИТЬКДАТЕ(РаботникиОрганизаций.Период, СЕКУНДА, -1), ДЕНЬ) 
		|	 ИНАЧЕ NULL
	...
	Если (РегламентированнаяОтчетность.ИДКонфигурации() <> "УПП") 
		И (РегламентированнаяОтчетность.ИДКонфигурации() <> "ЗУП") Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "РаботникиОрганизаций.ГрафикРаботы.СокращенноеРабочееВремя","ВЫБОР КОГДА РаботникиОрганизаций.ЗанимаемыхСтавок > 0 И РаботникиОрганизаций.ЗанимаемыхСтавок < 1 ТОГДА ИСТИНА ИНАЧЕ ЛОЖЬ КОНЕЦ");
	...
	Если Метаданные.РегистрыСведений.РаботникиОрганизаций.Реквизиты.Найти("СтатьяКЗоТ") = Неопределено Тогда
	    Запрос.Текст = СтрЗаменить(Запрос.Текст, "РаботникиОрганизаций.СтатьяКЗОТ КАК СтатьяКЗОТ, //новый реквизит","NULL КАК СтатьяКЗОТ,");
	КонецЕсли;		
	...
	Запрос.Текст =
		...
		|	ВЫБОР
		|		КОГДА РаботникиОрганизаций.Сотрудник.ВидЗанятости = ЗНАЧЕНИЕ(Перечисление.ВидыЗанятостиВОрганизации.ОсновноеМестоРаботы)
		|			ТОГДА 1
		|		ИНАЧЕ 2
		|	КОНЕЦ КАК Категория,
		|	ФИОФизЛицСрезПоследних.Фамилия КАК Фамилия,
		...
		|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ФИОФизЛиц.СрезПоследних(КОНЕЦПЕРИОДА(&ПериодОтчета, МЕСЯЦ), ) КАК ФИОФизЛицСрезПоследних
		|	ПО РаботникиОрганизаций.Сотрудник.ФизЛицо = ФИОФизЛицСрезПоследних.ФизЛицо
		|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ГражданствоФизЛиц.СрезПоследних(КОНЕЦПЕРИОДА(&ПериодОтчета, МЕСЯЦ), ) КАК ГражданствоФизЛиц
		...
		|   ЛЕВОЕ СОЕДИНЕНИЕ 
		|   Справочник.ДолжностиОрганизаций КАК ДолжностиПредыдущий
	...
	Если (РегламентированнаяОтчетность.ИДКонфигурации() <> "УПП") 
		...
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "Справочник.ОснованияУвольненияИзОрганизации КАК","Справочник.ОснованияУвольненийИзОрганизаций КАК");
		
		Если Метаданные.Справочники.ОснованияУвольненийИзОрганизаций.Реквизиты.Найти("СтатьяЗакона") = Неопределено Тогда
	   		Запрос.Текст = СтрЗаменить(Запрос.Текст, "ОснованияУвольненияИзОрганизации.СтатьяЗакона","ОснованияУвольненияИзОрганизации.Наименование");
		КонецЕсли;		
		
	Иначе
		
		Если Метаданные.Справочники.ОснованияУвольненияИзОрганизации.Реквизиты.Найти("СтатьяЗакона") = Неопределено Тогда
		    Запрос.Текст = СтрЗаменить(Запрос.Текст, "ОснованияУвольненияИзОрганизации.СтатьяЗакона","ОснованияУвольненияИзОрганизации.Наименование");
		КонецЕсли;		
	...
	Если (РегламентированнаяОтчетность.ИДКонфигурации() = "УТП") Тогда 
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "Справочник.ДолжностиОрганизаций КАК","Справочник.Должности КАК");
		...
		Если Метаданные.Справочники.Должности.Реквизиты.Найти("КодЗКППТР") = Неопределено Тогда
		    Запрос.Текст = СтрЗаменить(Запрос.Текст, "Должности.КодЗКППТР","""""");
		КонецЕсли;
	Иначе	
		Если Метаданные.Справочники.ДолжностиОрганизаций.Реквизиты.Найти("НаименованиеПоКП") = Неопределено Тогда
		    Запрос.Текст = СтрЗаменить(Запрос.Текст, "Должности.НаименованиеПоКП","""""");
		КонецЕсли;		
			
		Если Метаданные.Справочники.ДолжностиОрганизаций.Реквизиты.Найти("КодЗКППТР") = Неопределено Тогда
		    Запрос.Текст = СтрЗаменить(Запрос.Текст, "Должности.КодЗКППТР","""""");
		КонецЕсли;		
	КонецЕсли;
...
Функция  ПолучитьСписокДоговоровГПХ()
	...
	Если (РегламентированнаяОтчетность.ИДКонфигурации() = "БП") Тогда
		...
		ЗапросГПХ.Текст =  "ВЫБРАТЬ
						   ...
						   |	МАКСИМУМ(NULL) КАК СтатьяКЗОТ,
						   |	МАКСИМУМ(NULL) КАК Основание,
						   |	МАКСИМУМ(NULL) КАК ОснованиеНомер,
						   |	МАКСИМУМ(NULL) КАК ОснованиеДата,
						   |	МАКСИМУМ(ВЫБОР
		                   |			КОГДА ЕСТЬNULL(ГражданствоФизЛиц.НеЯвляетсяНалоговымРезидентом, ЛОЖЬ)
		                   |				ТОГДА 0
		                   |			КОГДА ЕСТЬNULL(ГражданствоФизЛиц.Страна, ЗНАЧЕНИЕ(Справочник.КлассификаторСтранМира.ПустаяСсылка)) = ЗНАЧЕНИЕ(Справочник.КлассификаторСтранМира.ПустаяСсылка)
	...
	Иначе	
		...
		ЗапросГПХ.Текст = "ВЫБРАТЬ
							  ...
							  |	Работники.ОснованиеПрекращения КАК СтатьяКЗОТ
		...
		Если Метаданные.Документы.ДоговорНаВыполнениеРаботСФизЛицом.Реквизиты.Найти("ОснованиеПрекращения") = Неопределено Тогда
			Если (РегламентированнаяОтчетность.ИДКонфигурации() = "УТП") Тогда						  
		    	ЗапросГПХ.Текст = СтрЗаменить(ЗапросГПХ.Текст, "Работники.ОснованиеПрекращения", "ЗНАЧЕНИЕ(Справочник.ОснованияУвольненийИзОрганизаций.ПустаяСсылка)");
			Иначе
		   		ЗапросГПХ.Текст = СтрЗаменить(ЗапросГПХ.Текст, "Работники.ОснованиеПрекращения", "ЗНАЧЕНИЕ(Справочник.ОснованияУвольненияИзОрганизации.ПустаяСсылка)");
			КонецЕсли;		
		КонецЕсли;	
		...
		ЗапросГПХ.Текст = "ВЫБРАТЬ
		                  |	Работники.Сотрудник КАК Сотрудник,
						  |	МИНИМУМ(Работники.ДатаПриема) КАК ДатаНач,
						  |	МАКСИМУМ(Работники.ДатаУвольнения)КАК ДатаКон,
		                  |	МАКСИМУМ(ФИОФизЛицСрезПоследних.Фамилия) КАК Фамилия,
		                  |	МАКСИМУМ(ФИОФизЛицСрезПоследних.Имя) КАК Имя,
		                  |	МАКСИМУМ(ФИОФизЛицСрезПоследних.Отчество) КАК Отчество,
						  |	МАКСИМУМ(ВЫБОР
		...
		ЗапросГПХ.Текст = "ВЫБРАТЬ
		                  |	Работники.Сотрудник КАК Сотрудник,
						  |	Работники.ГПХпоОснМестуРаботы КАК ГПХпоОснМестуРаботы,
						  |	Работники.Физлицо КАК ФизЛицо,
					      |	Работники.КодПоДРФО КАК КодПоДРФО,
						  |	Работники.ДатаПриема КАК ДатаПриема,
						  |	Работники.ДатаУвольнения КАК ДатаУвольнения,
						  |	Работники.Основание КАК Основание,
						  |	Работники.Основание.Дата КАК ОснованиеДата,
						  |	Работники.Основание.Номер КАК ОснованиеНомер,
						  |	ОснованияУвольненияИзОрганизации.СтатьяЗакона КАК СтатьяКЗОТ,
		                  |	ФИОФизЛицСрезПоследних.Фамилия КАК Фамилия,
		                  |	ФИОФизЛицСрезПоследних.Имя КАК Имя,
		                  |	ФИОФизЛицСрезПоследних.Отчество КАК Отчество,
						  ...
						  |   ЛЕВОЕ СОЕДИНЕНИЕ 
						  |   Справочник.ОснованияУвольненияИзОрганизации КАК ОснованияУвольненияИзОрганизации
					      |   ПО ОснованияУвольненияИзОрганизации.Ссылка = Работники.СтатьяКЗОТ
						  |УПОРЯДОЧИТЬ ПО
		                  |	Фамилия, Имя, Отчество, ДатаПриема";
						  
		Если (РегламентированнаяОтчетность.ИДКонфигурации() <> "УПП") 
			И (РегламентированнаяОтчетность.ИДКонфигурации() <> "ЗУП") Тогда
			
			ЗапросГПХ.Текст = СтрЗаменить(ЗапросГПХ.Текст, "Справочник.ОснованияУвольненияИзОрганизации КАК","Справочник.ОснованияУвольненийИзОрганизаций КАК");
			
			Если Метаданные.Справочники.ОснованияУвольненийИзОрганизаций.Реквизиты.Найти("СтатьяЗакона") = Неопределено Тогда
		   		ЗапросГПХ.Текст = СтрЗаменить(ЗапросГПХ.Текст, "ОснованияУвольненияИзОрганизации.СтатьяЗакона","ОснованияУвольненияИзОрганизации.Наименование");
			КонецЕсли;		
		...
		Если Результат.Количество() > 0 И УсловиеНаПодразделение() <> "" Тогда
			Сообщить(НСтр("ru = 'В форме отчета указано подразделение. Невозможно в таблице 6 указать данные по работникам по договорам ГПХ только по указанному подразделению. В Таблице 6 будет выведена информация по всем работникам ГПХ Организации'; uk = 'У формі звіту зазначено підрозділ. Неможливо в таблиці 6 вказати дані по працівниках за договорами ЦПХ тільки за вказаним підрозділом. У Таблиці 6 буде виведена інформація по всім працівникам ЦПХ Організації'"));
			Сообщить(НСтр("ru = 'В форме отчета указано подразделение. Невозможно заполнить количество сотрудников, работающих по ГПХ в Таблице 6 только по подразделению. Будет указано количество в целом по организации.'; uk = 'У формі звіту зазнечний Підрозділ. Неможливо заповнити кількість співробітників, що працюють за договорами ЦПХ у Таблиці 1 лише по підрозділу. Буде зазначена кількість в цілому по організації.'"));
		КонецЕсли;
...
Функция ПолучитьСписокОтпуска(СписокВидовРасчета, ПоРегистратору = Ложь)
	...
	ИначеЕсли ПоРегистратору Тогда
		...
		|	Начисления.Гражданин,
		|   ВЫБОР
		|    КОГДА Начисления.Начало ЕСТЬ NULL 
		|     ТОГДА NULL
		...
		|    КОГДА Начисления.Начало ЕСТЬ NULL 
		|     ТОГДА NULL
		|	 ИНАЧЕ Начисления.Регистратор.Дата 
		|   КОНЕЦ КАК ОснованиеДата,
		|   ВЫБОР
		|    КОГДА Начисления.Начало ЕСТЬ NULL 
		|     ТОГДА NULL
		|	 ИНАЧЕ Начисления.Регистратор.Номер 
	...
	Иначе
		...
		|	И НАЧАЛОПЕРИОДА(СостояниеРаботниковОрганизаций.Период, МЕСЯЦ) = &ДатаНач
		|   И СостояниеРаботниковОрганизаций.Состояние В (&Состояния)
		|;
		|
		|ВЫБРАТЬ
		|	Начисления.Сотрудник,
		...
		|    КОГДА Начисления.Начало ЕСТЬ NULL 
		|     ТОГДА NULL
		|    КОГДА Состояния.Регистратор ЕСТЬ NULL 
		|     ТОГДА NULL
		|	 ИНАЧЕ Состояния.Регистратор 
		|   КОНЕЦ КАК Основание,
		|   ВЫБОР
		|    КОГДА Начисления.Начало ЕСТЬ NULL 
		|     ТОГДА NULL
		|    КОГДА Состояния.Регистратор ЕСТЬ NULL 
		|     ТОГДА NULL
		|	 ИНАЧЕ Состояния.Регистратор.Дата 
		|   КОНЕЦ КАК ОснованиеДата,
		|   ВЫБОР
		|    КОГДА Начисления.Начало ЕСТЬ NULL 
		|     ТОГДА NULL
		|    КОГДА Состояния.Регистратор ЕСТЬ NULL 
		|     ТОГДА NULL
		|	 ИНАЧЕ Состояния.Регистратор.Номер 
		|   КОНЕЦ КАК ОснованиеНомер
		|ИЗ
		|	ВТОтпуска КАК Начисления
		|   ЛЕВОЕ СОЕДИНЕНИЕ
		|	ВТСостояния КАК Состояния
		|	ПО Начисления.Сотрудник = Состояния.Сотрудник
		|	 И Начисления.Начало = Состояния.Период
		|
		|УПОРЯДОЧИТЬ ПО
		|   Фамилия, Имя, Отчество, Начало
		|";	
	...
	Если мСохраненныйДок = Неопределено Тогда
		...
		Иначе
			...
			Иначе	
				...
				КонецЦикла;
				Если мМенеджерЗвит1С = Неопределено Тогда
					// Предупреждаем только если это не FREDO Звіт
			...
			текКадровыйПереводДвумяСтроками = ВосстановитьЗначение("РегламентированнаяОтчетность_ЕСВ_КадровыйПереводДвумяСтроками");
			Если текКадровыйПереводДвумяСтроками = Неопределено Тогда
				КадровыйПереводДвумяСтроками = Истина;
			Иначе	
			    КадровыйПереводДвумяСтроками = текКадровыйПереводДвумяСтроками;
			КонецЕсли;
...
Функция СформироватьДанныеДляЗвит1С() Экспорт 
	...
	Иначе
		...
		Если    Сред(мМенеджерЗвит1С.ИмяСхемыЗвит1С, 2,5) = "30401"
			ИЛИ Сред(мМенеджерЗвит1С.ИмяСхемыЗвит1С, 2,5) = "30405" 
			ИЛИ Сред(мМенеджерЗвит1С.ИмяСхемыЗвит1С, 2,5) = "30406" Тогда
			...
			Если НЕ КнопкиПанели.Найти("Действие2") = Неопределено Тогда
				КнопкиПанели.Действие2.Текст = "Продовжити заповненния в ""FREDO Звіт""";
			КонецЕсли;
...
Функция ОбработатьДРФО(Знач ДРФО)
	...
	ИначеЕсли СтрДлина(ДРФО) = 9 Тогда
		...
		Если ОбщегоНазначения.ТолькоЦифрыВСтроке(ДРФО) Тогда
...
Функция ОбработатьПредставлениеОснования(Основание, ОснованиеДата)
	...
	ОснованиеНомер = ОбщегоНазначения.ПолучитьНомерНаПечать(Основание);
...
Процедура  ОпределитьСписокВыгружаемыхСхем()
	...
	Для Каждого стр Из  тбСхемыXML Цикл
		...
		ИначеЕсли стр.НазваниеСтраницыПанели = "Таблица6" Тогда	
			...
			Если ТаблицаМногострочнойЧастиПуста(СтруктураГруппы6, мИдГруппы7) Тогда
				стр.фВыгрузка = 0;
			Иначе
				стр.фВыгрузка = 1;
			КонецЕсли;
...
Процедура ОбработкаВыбора(ЗначениеВыбора, Источник)
	...
	Если ТипЗнч(ЗначениеВыбора) = Тип("Структура") Тогда
		...
		Если  ЗначениеВыбора.Свойство("ИмяПоказателя", 		ИмяПоказателя)
			...
			Если  ИмяПоказателя = "HKVED" Тогда
				ИмяПоказателя = "HKVED_1";
			КонецЕсли;
...
ОписаниеТиповЧисло4 = ОбщегоНазначения.ПолучитьОписаниеТиповЧисла(4,0);
...
СтруктураГруппы5.Колонки.Добавить("T1RG111", ОписаниеТиповЧисло2);
СтруктураГруппы5.Колонки.Добавить("T1RG112", ОписаниеТиповЧисло2);
СтруктураГруппы5.Колонки.Добавить("T1RG12S", ОписаниеТиповСтрока);
СтруктураГруппы5.Колонки.Добавить("T1RG13", ОписаниеТиповЧисло5);
СтруктураГруппы5.Колонки.Добавить("T1RG14S", ОписаниеТиповСтрока);
СтруктураГруппы5.Колонки.Добавить("T1RG15S", ОписаниеТиповСтрока);
СтруктураГруппы5.Колонки.Добавить("T1RG16S", ОписаниеТиповСтрока);
СтруктураГруппы5.Колонки.Добавить("T1RG17S", ОписаниеТиповСтрока);
СтруктураГруппы5.Колонки.Добавить("T1RG18D", ОписаниеТиповДата);
СтруктураГруппы5.Колонки.Добавить("T1RG19S", ОписаниеТиповСтрока);
...
СтруктураГруппы6.Колонки.Добавить("T1RG111",ОписаниеТиповЧисло2);
СтруктураГруппы6.Колонки.Добавить("T1RG112",ОписаниеТиповЧисло4);
...
СтруктураГруппы6.Колонки.Добавить("T1RG13",  ОписаниеТиповЧисло3);
СтруктураГруппы6.Колонки.Добавить("T1RG14",  ОписаниеТиповЧисло3);
...
СтруктураГруппы7.Колонки.Добавить("T1RG10",   	ОписаниеТиповЧисло0);
СтруктураГруппы7.Колонки.Добавить("T1RG11",   	ОписаниеТиповЧисло0); 
...
мСоставПоказателей = "СоставПоказателей2018";

// ОПИСАНИЕ ПАРМЕТРОВ ФОРМЫ
//
// Версия формы
мВерсияФормы = "01/08/2018";
