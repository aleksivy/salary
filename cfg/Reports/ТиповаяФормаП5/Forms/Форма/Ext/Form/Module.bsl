...
Процедура ЗаголовокФормы()
	...
	Если ОтборОрганизации Тогда
		...
		Заголовок = НСтр("ru='Табель рабочего времени по ';uk='Табель робочого часу по '") 
		+ ?(ВидСравненияОрганизации = ВидСравнения.ВСписке Или ВидСравненияОрганизации = ВидСравнения.НеВСписке,НСтр("ru='списку организаций: ';uk='списку організацій: '"),НСтр("ru='организации: ';uk='організації: '")) 
