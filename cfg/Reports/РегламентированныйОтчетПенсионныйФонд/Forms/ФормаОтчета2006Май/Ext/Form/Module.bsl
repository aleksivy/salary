...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2006Май");
...
Процедура Расчет()
	...
	мОтчетПФ.Области.П3_2.Значение = ОкруглитьЧислоПоФормату(мОтчетПФ.Области.П3_2_2.Значение); 
...
Процедура РассчитатьСуммыВыплат()
	ТекстЗапроса = "
	 |ВЫБРАТЬ
	 |	ВзаиморасчетыСРаботникамиОрганизацийОбороты.СуммаНачисленийРасход КАК НачисленоПоФактуВыплаты
	 |ИЗ
	 |	РегистрНакопления.ВзаиморасчетыСРаботникамиОрганизаций.Обороты(&НачДата,&КонДата, ,Организация = &парамОрганизация) КАК ВзаиморасчетыСРаботникамиОрганизацийОбороты
	 |";
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		мОтчетПФ.Области.СправочноВыплач.Значение =  ТаблицаВыплатОтчетногоПериода[0].НачисленоПоФактуВыплаты;
	КонецЕсли;	
...
мСоставПоказателей = "СоставПоказателей2006Май";
