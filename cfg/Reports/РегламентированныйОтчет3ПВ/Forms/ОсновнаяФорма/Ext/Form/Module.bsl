...
Процедура ИзменитьПериод(Шаг)
	...
	Если Периодичность = Перечисления.Периодичность.Год Тогда
		//мДатаКонцаПериодаОтчета  = КонецГода(ДобавитьМесяц(мДатаКонцаПериодаОтчета, Шаг));
		мДатаКонцаПериодаОтчета  = ДобавитьМесяц(мДатаКонцаПериодаОтчета, Шаг);
...
Процедура ПриОткрытии()
    ПериодОтчета  = Перечисления.Периодичность.Квартал;
	...
	// Устанваливаем границы периода построения 
	
	мДатаНачалаПериодаОтчета = НачалоГода(РабочаяДата);
	
	Если ПериодОтчета = Перечисления.Периодичность.Квартал Тогда
...
//Период = Новый СписокЗначений;
//Период.Добавить(Перечисления.Периодичность.Квартал,"за первое полугодие");
//Период.Добавить(Перечисления.Периодичность.Год,"за год");

ЭлементыФормы.ПолеВыбораПериодичность.СписокВыбора.Добавить(Перечисления.Периодичность.Квартал,"за первое полугодие"); 
ЭлементыФормы.ПолеВыбораПериодичность.СписокВыбора.Добавить(Перечисления.Периодичность.Год,"за год"); 