...
Процедура ИзменитьПериод(Шаг)
	...
	Если Год(мДатаКонцаПериодаОтчета) >= 2012 Тогда
		Если Год(мДатаКонцаПериодаОтчета) = 2012 и Шаг < 0 Тогда
		    Периодичность = Перечисления.Периодичность.Месяц;
			мДатаКонцаПериодаОтчета = КонецМесяца(НачалоГода(мДатаКонцаПериодаОтчета));
		Иначе	
			Периодичность = Перечисления.Периодичность.Год;
		КонецЕсли;
	ИначеЕсли Год(мДатаКонцаПериодаОтчета) >= 2011 Тогда
		Если Месяц(мДатаКонцаПериодаОтчета) = 1 и Шаг < 0 Тогда
		    Периодичность = Перечисления.Периодичность.Квартал;
		ИначеЕсли Месяц(мДатаКонцаПериодаОтчета) = 12 и Шаг > 0 Тогда
			Периодичность = Перечисления.Периодичность.Год;
		Иначе	
			Периодичность = Перечисления.Периодичность.Месяц;
		КонецЕсли;
	Иначе	
		Если Месяц(КонецКвартала(мДатаКонцаПериодаОтчета)) = 12 и Шаг > 0 Тогда
			Периодичность = Перечисления.Периодичность.Месяц;
...
Процедура ПриОткрытии()
	...
	ИначеЕсли Периодичность = Перечисления.Периодичность.Месяц Тогда
		...
		мДатаНачалаПериодаОтчета = НачалоМесяца(мДатаКонцаПериодаОтчета);
	Иначе  //год
		мДатаКонцаПериодаОтчета  = КонецГода(ДобавитьМесяц(КонецМесяца(РабочаяДата), -12));
		мДатаНачалаПериодаОтчета = НачалоГода(мДатаКонцаПериодаОтчета);
	КонецЕсли;
