...
Функция  Сохранить()  Экспорт
	...
	СохранитьЗначение("РегламентированнаяОтчетность_ФСС_ПолучатьДанныеЗаПрошлыйПериодИзСохраненногоОтчета", ПолучатьДанныеЗаПрошлыйПериодИзСохраненногоОтчета);	
...
Процедура Расчет()
	...
	//1,9%
	мОтчетФССУтратаТрудосп.Области.S95_19.Значение   = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S171_19.Значение) 
	                                              + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S172_19.Значение) 
	                                              + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S173_19.Значение);
	...
	//1,4%
	мОтчетФССУтратаТрудосп.Области.S99_15.Значение   = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S161_15.Значение) 
	                                              + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S162_15.Значение) 
	                                              + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S163_15.Значение);
	...
	мОтчетФССУтратаТрудосп.Области.S8.Значение = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S5.Значение) 
											   ...
											   + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S99_15.Значение)
											   + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S95.Значение)
											   + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S95_19.Значение);
	...
	мОтчетФССУтратаТрудосп.Области.S170.Значение   = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S174.Значение) 
	                                               + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S95.Значение);
	//1,9%
	мОтчетФССУтратаТрудосп.Области.S170_19.Значение   = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S174_19.Значение) 
	                                               + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S95_19.Значение);
	...
	мОтчетФССУтратаТрудосп.Области.S160.Значение   = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S164.Значение) 
	                                               + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S99.Значение);
	//1,5%
	мОтчетФССУтратаТрудосп.Области.S160_15.Значение   = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S164_15.Значение) 
	                                               + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S99_15.Значение);
	...
	//1,5%
	мОтчетФССУтратаТрудосп.Области.S46_15.Значение = мОтчетФССУтратаТрудосп.Области.S194_15.Значение 
	                                            + мОтчетФССУтратаТрудосп.Области.S195_15.Значение 
	                                            + мОтчетФССУтратаТрудосп.Области.S196_15.Значение;
	//2,0%
	...
	//1,9%
	мОтчетФССУтратаТрудосп.Области.S230_19.Значение = мОтчетФССУтратаТрудосп.Области.S227_19.Значение 
	                                             + мОтчетФССУтратаТрудосп.Области.S228_19.Значение 
	                                             + мОтчетФССУтратаТрудосп.Области.S229_19.Значение;
	...
	//1,5%
	мОтчетФССУтратаТрудосп.Области.S193_15.Значение = мОтчетФССУтратаТрудосп.Области.S197_15.Значение 
	                                             + мОтчетФССУтратаТрудосп.Области.S46_15.Значение;
	...
	//1,9%                   
	мОтчетФССУтратаТрудосп.Области.S226_19.Значение = мОтчетФССУтратаТрудосп.Области.S231_19.Значение 
	                                             + мОтчетФССУтратаТрудосп.Области.S230_19.Значение;         
	...
	мОтчетФССУтратаТрудосп.Области.S7.Значение   = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S243.Значение) 
	                                             ...
	                                             + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S174_19.Значение) 
	                                             + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S164_15.Значение) 
	...
	мОтчетФССУтратаТрудосп.Области.S47.Значение = мОтчетФССУтратаТрудосп.Области.S267.Значение 
	                                            ...
	                                            + мОтчетФССУтратаТрудосп.Области.S197_15.Значение 
	                                            + мОтчетФССУтратаТрудосп.Области.S231_19.Значение
	...
	мОтчетФССУтратаТрудосп.Области.S9.Значение  = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S245.Значение) 
	                                                        ...
	                                                        + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S171_19.Значение) 
	                                                        + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S161_15.Значение) 
	...
	мОтчетФССУтратаТрудосп.Области.S49.Значение   = 		мОтчетФССУтратаТрудосп.Области.S264.Значение 
	                                                        ...
	                                                        + мОтчетФССУтратаТрудосп.Области.S194_15.Значение 
	                                                        + мОтчетФССУтратаТрудосп.Области.S227.Значение
	                                                        + мОтчетФССУтратаТрудосп.Области.S227_19.Значение;
	...
	мОтчетФССУтратаТрудосп.Области.S3.Значение    = ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S244.Значение) 
	                                                         ...
	                                                         + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S170_19.Значение) 
	                                                         + ОкруглитьЧислоПоФормату(мОтчетФССУтратаТрудосп.Области.S160_15.Значение) 
	...
	мОтчетФССУтратаТрудосп.Области.S52.Значение  = мОтчетФССУтратаТрудосп.Области.S263.Значение 
	                                                         ...
	                                                         + мОтчетФССУтратаТрудосп.Области.S193_15.Значение 
	                                                         + мОтчетФССУтратаТрудосп.Области.S226_19.Значение;
	...
	Если Не ЭтоЗУП Тогда
		...
		Для НомМес = 1 по Месяц(мДатаКонцаПериодаОтчета) Цикл
			...
			ПолученоОтФонда = мБухИтоги.ПолучитьИтог("СуммаКорОборотКт", "Период, Счет, КорСчет", мес, СчетФСС, СчетРасчСчет1)
							...
							+ мБухИтоги.ПолучитьИтог("СуммаКорОборотКт", "Период, Счет, КорСчет", мес, СчетФСС, СчетРасчСчет3);
			Если инд <> 0 Тогда
...
Процедура РасчетСуммЯнварь2009(Сумма = 0, База = 0)
	
	// в январе изменились с 13-го числа ставки по взносам в ФОТ. 
	// определим сумму и базу по старым ставкам.
	Запрос = Новый Запрос();
	Если    РегламентированнаяОтчетность.ИДКонфигурации() = "ЗУП"
		ИЛИ РегламентированнаяОтчетность.ИДКонфигурации() = "УПП" Тогда
		Запрос.Текст = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
		               |	ЕстьNULL(СУММА(ВзаиморасчетыПоВзносамВФонды.БазаВзноса), 0) КАК База,
		               |	ЕстьNULL(СУММА(ВзаиморасчетыПоВзносамВФонды.Результат), 0)  КАК Сумма
		               |ИЗ
		               |	Документ.НачислениеЗарплатыРаботникамОрганизаций.ВзносыФОТ КАК ВзаиморасчетыПоВзносамВФонды
		               |ГДЕ
					   |	ВзаиморасчетыПоВзносамВФонды.Ссылка.Проведен
					   |	И ВзаиморасчетыПоВзносамВФонды.Ссылка.Организация = &Организация
		               |	И ВзаиморасчетыПоВзносамВФонды.СтатьяНалоговойДекларации = &ФССВзносыФот
		               |	И НАЧАЛОПЕРИОДА(ВзаиморасчетыПоВзносамВФонды.ДатаНачала, МЕСЯЦ) = ДАТАВРЕМЯ(2009, 1, 1)
		               |	И (НЕ ВзаиморасчетыПоВзносамВФонды.Ставка = &Ставка14)";
	...
	Иначе	
		Запрос.Текст = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
		               ...
		               |ГДЕ
		               |	ВзаиморасчетыПоВзносамВФонды.Организация = &Организация
		               |	И ВзаиморасчетыПоВзносамВФонды.СтатьяНалоговойДекларации = &ФССВзносыФот
		               |	И ВзаиморасчетыПоВзносамВФонды.ВидДвижения = &Приход
		               |	И НАЧАЛОПЕРИОДА(ВзаиморасчетыПоВзносамВФонды.ПериодВзаиморасчетов, МЕСЯЦ) = ДАТАВРЕМЯ(2009, 1, 1)
		               |	И (НЕ ВзаиморасчетыПоВзносамВФонды.Ставка = &Ставка14)";
	
    КонецЕсли;
				   
	Запрос.УстановитьПараметр("Организация", Организация);
	Запрос.УстановитьПараметр("ФССВзносыФот", Справочники.СтатьиНалоговыхДеклараций.ФССУтрТрудосп_Орг29);
	Запрос.УстановитьПараметр("Приход", ВидДвиженияНакопления.Приход);
	
	Запрос.УстановитьПараметр("Ставка14", 0.014);
...
Процедура ЗаполнитьАвто()  Экспорт
   ...
   УстановитьЗначениеПоказателя("S2", S2);
	...
	ТекстЗапроса = "
		...
		|НАЧАЛОПЕРИОДА(ВзаиморасчетыПоВзносам.Период,МЕСЯЦ) КАК МесяцРегистрации,
	...
	ТекстЗапроса = ТекстЗапроса + "
    	|ИЗ РегистрНакопления.ВзаиморасчетыПоВзносамВФонды.ОстаткиИОбороты(&НачДата,&КонДата,МЕСЯЦ) КАК ВзаиморасчетыПоВзносам
		|
		|ГДЕ 
		...
		|	НАЧАЛОПЕРИОДА(ВзаиморасчетыПоВзносам.Период,МЕСЯЦ),
		...
		Для каждого НужнаяСтатья из МассивСтатей Цикл
			...
			Для каждого НайденнаяСтрока Из НайденныеСтроки Цикл
				...
				Иначе
					...
					мОтчетФССУтратаТрудосп.Области[ИмяЯчейкиМес].Значение = мОтчетФССУтратаТрудосп.Области[ИмяЯчейкиМес].Значение
					+ НайденнаяСтрока.БазаОборот;
				КонецЕсли;
			КонецЦикла;
	...
	Если ЭтоЗУП Тогда
		...
		Для мес = Месяц (НачалоГода(мДатаНачалаПериодаОтчета)) по Месяц(мДатаКонцаПериодаОтчета) Цикл
			ТекМесяц = ДобавитьМесяц(НачалоГода(мДатаНачалаПериодаОтчета),i);
			Отбор.Вставить("МесяцРегистрации",ТекМесяц);
			j = 0;
			Для каждого НужнаяСтатья из МассивСтатей Цикл
				Отбор.Вставить("СтатьяНалоговойДекларации",НужнаяСтатья);
				// результатом поиска всегда будет только одна строка, не массив
				...
				Для каждого НайденнаяСтрока Из НайденныеСтроки Цикл
					...
					Если (Месяц(ТекМесяц) < Месяц(мДатаНачалаПериодаОтчета)) Тогда
						...
						+ НайденнаяСтрока.НачисленоВзноса;
									
						//накаплитваем сумму "перечислено на начало квартала"
						мОтчетФССУтратаТрудосп.Области["S215"].Значение = мОтчетФССУтратаТрудосп.Области["S215"].Значение 
						+ НайденнаяСтрока.УплаченоПодтверждено;
					...
					Иначе
						...
						мОтчетФССУтратаТрудосп.Области[ИмяЯчейкиМесВзн].Значение = мОтчетФССУтратаТрудосп.Области[ИмяЯчейкиМесВзн].Значение 
						+ НайденнаяСтрока.НачисленоВзноса;
	...
	// особый алгоритм расчета для месяца с изменением ставки в течение месяца
	Если  Год(мДатаНачалаПериодаОтчета) = 2009 Тогда
		
		Сумма15 = 0;
		База15  = 0;
		РасчетСуммЯнварь2009(Сумма15, База15);
		
		Если 1 < Месяц(мДатаНачалаПериодаОтчета) Тогда
			мОтчетФССУтратаТрудосп.Области["S164_15"].Значение = База15;
			мОтчетФССУтратаТрудосп.Области["S164"].Значение = мОтчетФССУтратаТрудосп.Области["S164"].Значение - База15;
			
			мОтчетФССУтратаТрудосп.Области["S197_15"].Значение = Сумма15;
			мОтчетФССУтратаТрудосп.Области["S197"].Значение = мОтчетФССУтратаТрудосп.Области["S197"].Значение - Сумма15;
		Иначе	
			мОтчетФССУтратаТрудосп.Области["S161_15"].Значение = База15;
			мОтчетФССУтратаТрудосп.Области["S161"].Значение = мОтчетФССУтратаТрудосп.Области["S161"].Значение - База15;
			
			мОтчетФССУтратаТрудосп.Области["S194_15"].Значение = Сумма15;
			мОтчетФССУтратаТрудосп.Области["S194"].Значение = мОтчетФССУтратаТрудосп.Области["S194"].Значение - Сумма15;
		КонецЕсли;
	...
	Если ПолучатьДанныеЗаПрошлыйПериодИзСохраненногоОтчета 
		...
		Если ТипЗнч(ДанныеПрошлыйПериод) = Тип("Структура") Тогда
			//II
			ДанныеПрошлыйПериод.Свойство("S244", 	мОтчетФССУтратаТрудосп.Области.S243.Значение);
			ДанныеПрошлыйПериод.Свойство("S249", 	мОтчетФССУтратаТрудосп.Области.S248.Значение);
			ДанныеПрошлыйПериод.Свойство("S160_15", мОтчетФССУтратаТрудосп.Области.S164_15.Значение);
			ДанныеПрошлыйПериод.Свойство("S160", 	мОтчетФССУтратаТрудосп.Области.S164.Значение);
			ДанныеПрошлыйПериод.Свойство("S170_19", мОтчетФССУтратаТрудосп.Области.S174_19.Значение);
			ДанныеПрошлыйПериод.Свойство("S170", 	мОтчетФССУтратаТрудосп.Области.S174.Значение);
			
			ДанныеПрошлыйПериод.Свойство("S175", 	мОтчетФССУтратаТрудосп.Области.S179.Значение);
			ДанныеПрошлыйПериод.Свойство("S180", 	мОтчетФССУтратаТрудосп.Области.S184.Значение);
			ДанныеПрошлыйПериод.Свойство("S165", 	мОтчетФССУтратаТрудосп.Области.S169.Значение);
			
			// III A
			ДанныеПрошлыйПериод.Свойство("S263", 	мОтчетФССУтратаТрудосп.Области.S267.Значение);
			ДанныеПрошлыйПериод.Свойство("S268", 	мОтчетФССУтратаТрудосп.Области.S272.Значение);
			ДанныеПрошлыйПериод.Свойство("S193_15", 	мОтчетФССУтратаТрудосп.Области.S197_15.Значение);
			ДанныеПрошлыйПериод.Свойство("S193", 	мОтчетФССУтратаТрудосп.Области.S197.Значение);
			ДанныеПрошлыйПериод.Свойство("S226_19", 	мОтчетФССУтратаТрудосп.Области.S231_19.Значение);
			ДанныеПрошлыйПериод.Свойство("S226", 	мОтчетФССУтратаТрудосп.Области.S231.Значение);
			
			ДанныеПрошлыйПериод.Свойство("S203", 	мОтчетФССУтратаТрудосп.Области.S207.Значение);
			ДанныеПрошлыйПериод.Свойство("S208", 	мОтчетФССУтратаТрудосп.Области.S213.Значение);
			ДанныеПрошлыйПериод.Свойство("S198", 	мОтчетФССУтратаТрудосп.Области.S202.Значение);
			
			// III
			ДанныеПрошлыйПериод.Свойство("S20", 	мОтчетФССУтратаТрудосп.Области.S20.Значение);
			ДанныеПрошлыйПериод.Свойство("S33", 	мОтчетФССУтратаТрудосп.Области.S33.Значение);
			
			ДанныеПрошлыйПериод.Свойство("S34", 	мОтчетФССУтратаТрудосп.Области.S214.Значение);
			
			ДанныеПрошлыйПериод.Свойство("S185", 	мОтчетФССУтратаТрудосп.Области.S185.Значение);
			
			ДанныеПрошлыйПериод.Свойство("S35", 	мОтчетФССУтратаТрудосп.Области.S215.Значение);
			
			// "Отримано від Фонду з початку року" (III. р. 9)   
			ДанныеПрошлыйПериод.Свойство("S30", 	мОтчетФССУтратаТрудосп.Области.S100.Значение);
	...
	//  Задолженность по страховым взносам, срок уплаты которых не настал	
		...
		// задолженность не может превыщать итоговой задолженности													 
		мОтчетФССУтратаТрудосп.Области.S126.Значение = МИН(мОтчетФССУтратаТрудосп.Области.S126.Значение, мОтчетФССУтратаТрудосп.Области.S37.Значение);											 
	...
	ПроверитьСовпадениеРасшифровокПоказателейРазделаIII();
...
Процедура ПроверитьСовпадениеРасшифровокПоказателейРазделаIII()

   Если мОтчетФССУтратаТрудосп.Области.S86.Значение <> 
	   		мОтчетФССУтратаТрудосп.Области.S34.Значение Тогда
   
		Сообщить("Не совпадает значение строки 10 раздела IV со значением строки 14 раздела III отчета!");	
   
   КонецЕсли;
	
   Если мОтчетФССУтратаТрудосп.Области.S37.Значение <>
			( мОтчетФССУтратаТрудосп.Области.S126.Значение
			...
			+ мОтчетФССУтратаТрудосп.Области.S135.Значение) Тогда
			
		Сообщить("Не совпадает сумма показателей раздела V со значением строки 17 раздела III отчета!");	
   
   КонецЕсли;	
   
   Если мОтчетФССУтратаТрудосп.Области.S32.Значение <>
			( мОтчетФССУтратаТрудосп.Области.S130.Значение
			+ мОтчетФССУтратаТрудосп.Области.S131.Значение
			+ мОтчетФССУтратаТрудосп.Области.S132.Значение
			+ мОтчетФССУтратаТрудосп.Области.S133.Значение
			+ мОтчетФССУтратаТрудосп.Области.S134.Значение) Тогда
			
		Сообщить("Не совпадает сумма показателей раздела VI со значением строки 12 раздела III отчета!");	
...
Функция ПолучитьДанныеЗаПрошлыйПериод()
	...
	ИначеЕсли  РезультатЗапроса.Количество() > 1 Тогда
		Сообщить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='За %1 обнаружено более одного сохраненного отчета! Показатели на начало квартала не будут получены из сохраненного отчета!';uk='За %1 виявлено більше одного збереженого звіту!  Показники на початок кварталу не будуть отримані зі збереженного звіту!'"), ПредставлениеПериода(ДатаНачала, ДатаОкончания, "Л = ""uk_UA""; ФП = Истина" ))); 
		Возврат Неопределено;
	Иначе	
		ДанныеОтчета = РезультатЗапроса[0].ДанныеОтчета.Получить();
		ДанныеОтчета.Свойство("ПоказателиОтчета",ПоказателиОтчета);
		НаименованиеПоля = "ПолеТабличногоДокументаОтчетФССУтратаТрудосп";
...
Процедура ПриОткрытии()
	...
	Если мСохраненныйДок = Неопределено Тогда
		...
		ПолучатьДанныеЗаПрошлыйПериодИзСохраненногоОтчета = ВосстановитьЗначение("РегламентированнаяОтчетность_ФСС_ПолучатьДанныеЗаПрошлыйПериодИзСохраненногоОтчета");	
...
Процедура КоманднаяПанельДействийДействиеXML(Кнопка) Экспорт
	...
	Предупреждение(НСТР("ru = 'В связи с отсутствием обновленной схемы выгрузки в АРМ данная возможность отключена!'; uk = 'У зв''язку з відсутністю оновленної схеми вивантаження до АРМ ця можливість відключена!'"));
	Возврат;
