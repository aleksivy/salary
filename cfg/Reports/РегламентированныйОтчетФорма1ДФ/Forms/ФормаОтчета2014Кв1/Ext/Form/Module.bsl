...
Функция ПолучитьНастройкиПроверкиЗаполенения(Макет = "СоставПоказателей2014кв1") Экспорт
...
Функция ОбновитьВариантыЗаполнения()
	...
	МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2014кв1");
...
Перем СтруктураГруппы;
	...
	Макет        = ПолучитьМакет("ПечатнаяФорма2014");
...
Процедура ЗаполнитьАвто()  Экспорт
	...
	Иначе	
		...
		|  	   И Организация = &Организация
		|  	   "+?(ЕстьВоенныйСбор,"И ДоходНДФЛ.ВидСтавкиРезидента <> ДоходНДФЛ.ВидСтавкиВоенныйСбор","")+"
		|	   " + УсловиеНаПодразделение + "
		|
		|   СГРУППИРОВАТЬ ПО
		|		ВЫБОР КОГДА ВзаиморасчетыПоНДФЛОбороты.Сотрудник ССЫЛКА Справочник.СотрудникиОрганизаций ТОГДА ВзаиморасчетыПоНДФЛОбороты.Сотрудник.ФизЛицо ИНАЧЕ ВзаиморасчетыПоНДФЛОбороты.Сотрудник КОНЕЦ,
		...
		|  	   			"+?(ЕстьВоенныйСбор,"И   ВзаиморасчетыПоНДФЛ.ДоходНДФЛ.ВидСтавкиРезидента <> ВзаиморасчетыПоНДФЛ.ДоходНДФЛ.ВидСтавкиВоенныйСбор","")+"
		|			" + УсловиеНаПодразделение + "
		|			СГРУППИРОВАТЬ ПО
