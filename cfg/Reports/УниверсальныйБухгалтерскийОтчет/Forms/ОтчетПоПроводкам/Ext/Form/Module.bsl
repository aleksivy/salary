...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	Если ТекущийНаборПоказателей <> мТекущийНаборПоказателей Тогда
		...
		Для Каждого ЭлементМассива Из МассивМакетов Цикл
			СхемаКД.Макеты[ЭлементМассива].Макет = мПолучитьКопиюОписанияМакета(СхемаКД.Макеты[ЭлементМассива + "Образец"].Макет);
			ОписаниеМакета = СхемаКД.Макеты[ЭлементМассива].Макет;
	...
	Если Не ПоказателиОтчета.БУ.Значение Тогда
		...
		Если ПоказателиОтчета.НУ.Значение Тогда
			мДобавитьОтбор(ГруппаОтборов, "НУДт", 0, ВидСравненияКомпоновкиДанных.НеРавно);
			мДобавитьОтбор(ГруппаОтборов, "НУКт", 0, ВидСравненияКомпоновкиДанных.НеРавно);
		КонецЕсли;
		Если ПоказателиОтчета.ВалютнаяСумма.Значение Тогда
			мДобавитьОтбор(ГруппаОтборов, "ВалютнаяСуммаДт", 0, ВидСравненияКомпоновкиДанных.НеРавно);
			мДобавитьОтбор(ГруппаОтборов, "ВалютнаяСуммаКт", 0, ВидСравненияКомпоновкиДанных.НеРавно);
		КонецЕсли;
	КонецЕсли;
	...
	Для Каждого ЭлементОтбора Из МассивОтборов Цикл
		ГруппаИЛИ = КН.Настройки.Отбор.Элементы.Добавить(Тип("ГруппаЭлементовОтбораКомпоновкиДанных"));
		ГруппаИЛИ.ТипГруппы = ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИли;
		мДобавитьОтбор(ГруппаИЛИ, СтрЗаменить(ЭлементОтбора.ЛевоеЗначение, "Субконто", "СубконтоДт"), ЭлементОтбора.ПравоеЗначение, ЭлементОтбора.ВидСравнения); 
		мДобавитьОтбор(ГруппаИЛИ, СтрЗаменить(ЭлементОтбора.ЛевоеЗначение, "Субконто", "СубконтоКт"), ЭлементОтбора.ПравоеЗначение, ЭлементОтбора.ВидСравнения); 
...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = НСтр("ru='Отчет по проводкам';uk='Звіт по проводках'") + мПолучитьПредставлениеПериода(ЭтаФорма);
...
ИдентификаторОбъекта  = "ОтчетОбъект.ОтчетПоПроводкам";
ПредставлениеОтчета   = "Отчет по проводкам";

СхемаКД = ПолучитьМакет("ОтчетПоПроводкам");
