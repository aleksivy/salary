...
Процедура ИмяРегистраПриИзменении(Элемент)
	...
	Если СтрокаСписка<>Неопределено Тогда
		мНазваниеОтчета = "" + СтрокаСписка.Представление + НСтр("ru=': остатки и обороты';uk=': залишки й обороти'");
	КонецЕсли;
...
Процедура ПослеВосстановленияЗначений()
	...
	Если ТипЗнч(СохраненныеНастройки)=Тип("Структура") Тогда
		...
		//СохраненныеНастройки.Свойство("ИспользоватьИнтервальныеГруппировки", ИспользоватьИнтервальныеГруппировки);
	КонецЕсли;
...
ЭлементыФормы.ИмяРегистра.СписокВыбора = УправлениеОтчетами.ПолучитьСписокРегистровОстатков();
НеЗаполнятьНастройкиПриОткрытии = Ложь;
