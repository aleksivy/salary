	...
	ИначеЕсли ВРег(Тип) = ВРег("DGsti") Тогда
		...
		Попытка
			...
			Если    Найти(Результат, ".") > 0
				...
				ИЛИ Контроль > 99
				ИЛИ Цел(Контроль) <> Контроль Тогда
				ОписаниеОшибки = НСтр("ru='Значение не является целым числом от 1 до 99 (код ГНИ)';uk='Значення не є цілим числом від 1 до 99 (код ДПІ)'");					
			КонецЕсли;
		Исключение
			ОписаниеОшибки = НСтр("ru='Значение не является целым числом от 1 до 99 (код ГНИ)';uk='Значення не є цілим числом від 1 до 99 (код ДПІ)'");					
		КонецПопытки;
	...
	ИначеЕсли ВРег(Тип) = ВРег("DGc_dpi") Тогда
		...
		Попытка
			...
			Если    Найти(Результат, ".") > 0
				...
				ИЛИ Контроль > 2899
				ИЛИ Цел(Контроль) <> Контроль Тогда
				ОписаниеОшибки = НСтр("ru='Значение не является целым числом от 100 до 2899 (код ГНИ)';uk='Значення не є цілим числом від 100 до 2899 (код ДПІ)'");
			КонецЕсли;
		Исключение
			ОписаниеОшибки = НСтр("ru='Значение не является целым числом от 100 до 2899 (код ГНИ)';uk='Значення не є цілим числом від 100 до 2899 (код ДПІ)'");
		КонецПопытки;
	...
	ИначеЕсли (ВРег(Тип) = ВРег("Odoh1DFColumn"))
		...
		Попытка
			...
			Если    Найти(Результат, ".") > 0
				...
				ИЛИ Контроль > 185
				ИЛИ Цел(Контроль) <> Контроль Тогда
				ОписаниеОшибки = НСтр("ru='Значение не является целым числом от 101 до 185';uk='Значення не є цілим числом від 101 до 185'");
			КонецЕсли;
		Исключение
			ОписаниеОшибки = НСтр("ru='Значение не является целым числом от 101 до 185';uk='Значення не є цілим числом від 101 до 185'");
		КонецПопытки;
