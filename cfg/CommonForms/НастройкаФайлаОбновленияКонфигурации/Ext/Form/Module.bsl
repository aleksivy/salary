...
Процедура ОсновныеДействияФормыОК(Кнопка)
	...
	Если НЕ ПравоДоступа("Изменение", Метаданные.Константы.НастройкаФайлаОбновленияКонфигурации) Тогда
		...
		#Если Клиент Тогда
			ОбщегоНазначения.СообщитьОбОшибке(НСтр("ru='Нет прав на изменение константы ""Настройка файла обновления конфигурации""';uk='Немає прав на зміну константи ""Настройка файлу оновлення конфігурації""'"));
		#КонецЕсли
...
// при изменении формирования в ручную настроек или автоматчески
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если ЭтаФорма.Модифицированность И 
		...
		РезультатВопроса = Вопрос(НСтр("ru='Настройки файла обновления конфигурации изменены. Сохранить?';uk='Настройки файлу оновлення конфігурації змінені. Зберегти?'"), РежимДиалогаВопрос.ДаНетОтмена);
