...
Процедура ДействияФормаЗаполнитьНаДату(Кнопка)

	// Выберем дату курса
	Если ВвестиДату(ДатаУстановкиКурсаИКратности, НСтр("ru='Выберите дату установки курса и кратности.';uk='Виберіть дату установки курсу й кратності.'"), ЧастиДаты.Дата) Тогда

		// Если дата введена, заполним значение курса и кратности
		СтруктураВалюты = МодульВалютногоУчета.ПолучитьКурсВалюты(Валюта, ДатаУстановкиКурсаИКратности);
