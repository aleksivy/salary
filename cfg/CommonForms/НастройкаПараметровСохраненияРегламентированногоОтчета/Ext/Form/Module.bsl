...
// Процедура вызывается при изменении переключателя варианта сохранения.
...
// Процедура - обработчик нажатия кнопки "Сохранить".
Процедура Сохранить(Элемент)
	...
	Иначе
		Сообщить("Имя каталога задано неверно! Проверьте правильность указания имени каталога!",СтатусСообщения.Внимание);
	КонецЕсли;
