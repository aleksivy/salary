...
Процедура ДействияФормыСписокРаботников(Кнопка)
	...
	ПроцедурыУправленияПерсоналом.ОткрытьФормуОтбораСпискаРаботников(ЭтаФорма, Дата, , Организация, , , ,"ЗаявлениеНаПрименениеЛьготы", Новый Структура("ВидЛьготы,ДатаИзменения,Актуальность", ,,));
...
Процедура ОбработкаВыбора(ЗначениеВыбора, Источник)
	...
	Если ТипЗнч(ЗначениеВыбора) = Тип("Структура") Тогда
		...
		Если ЗначениеВыбора.Свойство("Команда",Команда) и Команда = "ЗаполнитьСписокРаботников" Тогда
			...
			ВременнаяТаблица.Колонки.Добавить("Льгота");
			ВременнаяТаблица.Колонки.Добавить("ДатаИзменения");
			ВременнаяТаблица.Колонки.Добавить("Актуальность");
			Для каждого СтрокаВременнойТаблицы Из ВременнаяТаблица Цикл
				СтрокаВременнойТаблицы.Льгота = ЗначениеВыбора.Реквизиты.ВидЛьготы;
				СтрокаВременнойТаблицы.ДатаИзменения = ЗначениеВыбора.Реквизиты.ДатаИзменения;
				СтрокаВременнойТаблицы.Актуальность = ЗначениеВыбора.Реквизиты.Актуальность;
			КонецЦикла;
