...
Функция РасчетДокументаРазрешен()
	...
	Если Не Успешно Тогда
		СтрокаЗаголовок = НСтр("ru='Расчет невозможентак, как выполнено начисление зарплаты за ';uk='Розрахунок неможливий, тому що виконане нарахування зарплати за '") 
...
Процедура УстановитьВидимостьПоУчетнойПолитике()
	...
	РезервОтпусков = РегистрыСведений.ПараметрыРасчетаЗарплатыОрганизаций.Получить(Новый Структура ("Организация", Организация)).ИспользованиеРезерваОтпусков;
	
	ЭлементыФормы.ОтражениеВУчете.Колонки.НеОтражатьВБУ.Видимость = РезервОтпусков;
...
Процедура СформироватьПроводки()
	Если (  Начисления.Количество() > 0 
		...
		ТекстВопроса = НСтр("ru='Текущие проводки будут удалены. Продолжить?';uk='Поточні проводки будуть вилучені. Продовжити?'");
		Ответ = Вопрос(ТекстВопроса, РежимДиалогаВопрос.ДаНет, , КодВозвратаДиалога.Да,);
	...
	Если Начисления.Количество() = 0 Тогда
		...
		Сообщить(НСтр("ru='Не обнаружены данные для формирования проводок.';uk='Не виявлені дані для формування проводок.'"), СтатусСообщения.Важное )
...
Процедура ОтражениеВУчетеНалоговоеНазначениеНДСНачалоВыбора(Элемент, СтандартнаяОбработка)
...
Процедура ОтражениеВУчетеНалоговоеНазначениеНДСАвтоПодборТекста(Элемент, Текст, ТекстАвтоПодбора, СтандартнаяОбработка)
...
Процедура ОтражениеВУчетеНалоговоеНазначениеНДСОкончаниеВводаТекста(Элемент, Текст, Значение, СтандартнаяОбработка)
...
Процедура НачисленияНалоговоеНазначениеНДСНачалоВыбора(Элемент, СтандартнаяОбработка)
	РаботаСДиалогами.НачалоВыбораЗначенияНалоговоеНазначение(Элемент, СтандартнаяОбработка,Перечисления.ГруппыНалоговыхНазначений.НалоговыеНазначенияАктивовИВзаиморасчетовПоНДС);
КонецПроцедуры

Процедура НачисленияНалоговоеНазначениеНДСАвтоПодборТекста(Элемент, Текст, ТекстАвтоПодбора, СтандартнаяОбработка)
	РаботаСДиалогами.АвтоПодборТекстаНалоговоеНазначение(ЭтаФорма, Элемент, Текст, ТекстАвтоПодбора, СтандартнаяОбработка, Перечисления.ГруппыНалоговыхНазначений.НалоговыеНазначенияАктивовИВзаиморасчетовПоНДС);
КонецПроцедуры

Процедура НачисленияНалоговоеНазначениеНДСОкончаниеВводаТекста(Элемент, Текст, Значение, СтандартнаяОбработка)
	РаботаСДиалогами.ОкончаниеВводаТекстаНалоговоеНазначение(Элемент, Текст, Значение, СтандартнаяОбработка, Перечисления.ГруппыНалоговыхНазначений.НалоговыеНазначенияАктивовИВзаиморасчетовПоНДС)
КонецПроцедуры
...
Процедура ВзносыФОТНалоговоеНазначениеНДСНачалоВыбора(Элемент, СтандартнаяОбработка)
	РаботаСДиалогами.НачалоВыбораЗначенияНалоговоеНазначение(Элемент, СтандартнаяОбработка,Перечисления.ГруппыНалоговыхНазначений.НалоговыеНазначенияАктивовИВзаиморасчетовПоНДС);
КонецПроцедуры

Процедура ВзносыФОТНалоговоеНазначениеНДСАвтоПодборТекста(Элемент, Текст, ТекстАвтоПодбора, СтандартнаяОбработка)
	РаботаСДиалогами.АвтоПодборТекстаНалоговоеНазначение(ЭтаФорма, Элемент, Текст, ТекстАвтоПодбора, СтандартнаяОбработка, Перечисления.ГруппыНалоговыхНазначений.НалоговыеНазначенияАктивовИВзаиморасчетовПоНДС);
КонецПроцедуры

Процедура ВзносыФОТНалоговоеНазначениеНДСОкончаниеВводаТекста(Элемент, Текст, Значение, СтандартнаяОбработка)
	РаботаСДиалогами.ОкончаниеВводаТекстаНалоговоеНазначение(Элемент, Текст, Значение, СтандартнаяОбработка, Перечисления.ГруппыНалоговыхНазначений.НалоговыеНазначенияАктивовИВзаиморасчетовПоНДС)
КонецПроцедуры
