...
// Серна - Начало
	Движение.Состояние				= ВыборкаПоШапкеДокумента.Состояние;
// Серна - Конец
...
Процедура ДобавитьСтрокуОсновныеНачисления(ВыборкаПоШапкеДокумента, ВыборкаПоСтрокамДокумента)
	...
	КонецЕсли;
// Серна - Начало
	// Для ограничения доступа к регистру плановых начислений
	Возврат;
// Серна - Конец
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	Если Не ЗначениеЗаполнено(Состояние) Тогда Состояние = Перечисления.СостоянияРаботникаОрганизации.ОтпускПоУходуЗаРебенком; КонецЕсли;
КонецПроцедуры
// Серна - Конец
////////////////////////////////////////////////////////////////////////////////
