...
КонецПроцедуры
// Серна - Начало
Процедура РаботникиОрганизацииРеквизитыДокументаОснованияНачалоВыбора(Элемент, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	Если ЗначениеЗаполнено(Элемент.Значение) Тогда
		лНайденноеЗначение = мСписокПричинУвольнения.НайтиПоЗначению( СокрЛП(Элемент.Значение) );
	КонецЕсли;
	лВыбранноеЗначение = ВыбратьИзСписка(мСписокПричинУвольнения, Элемент, лНайденноеЗначение);
	Если Не лВыбранноеЗначение = Неопределено Тогда
		Элемент.Значение = СокрЛП(лВыбранноеЗначение.Значение);
	КонецЕсли;
КонецПроцедуры

мСписокПричинУвольнения = Новый СписокЗначений;
мСписокПричинУвольнения.Добавить( "у зв’язку із переїздом на нове місце проживання." );
мСписокПричинУвольнения.Добавить( "у зв’язку із переведенням дружини або чоловіка на роботу в іншу місцевість." );
мСписокПричинУвольнения.Добавить( "вступ до навчального закладу." );
мСписокПричинУвольнения.Добавить( "неможливість проживати в даній місцевості, підтверджена медичним висновком." );
мСписокПричинУвольнения.Добавить( "догляд за дитиною до досягнення нею 14-річного віку або дитиною-інвалідом." );
мСписокПричинУвольнения.Добавить( "догляд за хворим членом сім’ї відповідно до медичного висновку або інвалідом І групи." );
мСписокПричинУвольнения.Добавить( "вихід на пенсію." );
мСписокПричинУвольнения.Добавить( "прийняття на роботу за конкурсом." );
// Серна - Конец
