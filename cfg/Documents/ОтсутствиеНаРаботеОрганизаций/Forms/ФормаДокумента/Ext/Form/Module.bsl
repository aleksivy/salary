...
Процедура ПриОткрытии()
	...
	// Установить ограничение - изменять видимость колонок для табличной части РаботникиОрганизации
	...
	СписокПричинОтсутствия = ПроцедурыУправленияПерсоналом.ПолучитьСписокПрочихСостоянийРаботника();
	ЭлементыФормы.РаботникиОрганизации.Колонки.ПричинаОтсутствия.ЭлементУправления.ДоступныеЗначения = СписокПричинОтсутствия;
	ЭлементыФормы.РаботникиОрганизации.Колонки.ПричинаОтсутствия.ЭлементУправления.ВысотаСпискаВыбора = СписокПричинОтсутствия.Количество();
	ЭлементыФормы.РаботникиОрганизации.Колонки.ПричинаОтсутствия.ЭлементУправления.ШиринаСпискаВыбора = 35;
...
"Записати і провести?'"),
	...
	Обработка.ТипДокумента = НСтр("ru='Отсутствие на работе организации';uk='Відсутність на роботі організації'");
...
// Процедура обеспечивает начальное значение реквизитов "ПричинаОтсутствия" 
//
// Параметры:
...
Процедура РаботникиОрганизацииПриНачалеРедактирования(Элемент, НоваяСтрока)
	...
	Если НоваяСтрока Тогда
		Элемент.ТекущиеДанные.ПричинаОтсутствия = Перечисления.СостоянияРаботникаОрганизации.Заболевание;
	КонецЕсли;
